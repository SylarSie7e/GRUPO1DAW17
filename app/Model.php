 ...
 class Model
 {
          ...
          public function buscarAlimentosPorEnergia($energia)
     {
         ...
         return $alimentos;
           ...
           public function buscarAlimentosCombinado($energia, $nombre)
     {
         $energia = htmlspecialchars($energia);
         $nombre = htmlspecialchars($nombre);

         $sql = "select * from alimentos where energia =" . $energia . " and nombre = '". $nombre ."'  order by energia desc";
     ...
     public function eliminarAli($nombre)
    {
        $nombre = htmlspecialchars($nombre);
